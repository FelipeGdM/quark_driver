...
int YoloV7::load(int _target_size) {
    ...
    yolo.load_param("/home/quark/main_ws/src/quark_driver/perception/cone_detection_ncnn/params/yolov7-tiny.param");
    yolo.load_model("/home/quark/main_ws/src/quark_driver/perception/cone_detection_ncnn/params/tiny_cone_weights.bin");
